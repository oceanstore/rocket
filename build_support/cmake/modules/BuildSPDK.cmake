macro(build_spdk)
  set(DPDK_DIR ${THIRD_PARTY_DIR}/spdk/dpdk)
  ...
  set(source_dir "${THIRD_PARTY_DIR}/spdk")
  foreach(c lvol env_dpdk sock nvmf bdev nvme conf thread trace_parser trace notify accel event_accel blob vmd event_vmd event_bdev sock_posix event_sock event rpc jsonrpc json util log)
  ...
  ExternalProject_Add(spdk-ext
    ...
    CONFIGURE_COMMAND ./configure
      --prefix=${THIRD_PARTY_DIR}/spdk/build
      --libdir=${THIRD_PARTY_DIR}/spdk/build/lib
      --with-dpdk=${THIRD_PARTY_DIR}/spdk/dpdk/build
      # --with-uring
      --with-crypto
      --disable-unit-tests
      --disable-tests
    ...
    BUILD_COMMAND env -i PATH=$ENV{PATH} CC=${CMAKE_C_COMPILER} ${make_exe} EXTRA_CFLAGS=${spdk_CFLAGS}
    # BUILD_COMMAND CC=${CMAKE_C_COMPILER} ${make_cmd} EXTRA_CFLAGS=${spdk_CFLAGS}
    BUILD_IN_SOURCE 1
