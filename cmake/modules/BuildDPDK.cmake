function(do_build_dpdk dpdk_dir)
  ...
  include(FindMeson)
  find_meson("meson_exe")
#   execute_process(
#     COMMAND ${MAKE_EXECUTABLE} showconfigs
#     WORKING_DIRECTORY ${THIRD_PARTY_DIR}/spdk/dpdk
#     OUTPUT_VARIABLE supported_targets
#     OUTPUT_STRIP_TRAILING_WHITESPACE)
#   string(REPLACE "\n" ";" supported_targets "${supported_targets}")
#   message("DEBUG: ${supported_targets}")
...
#   endif()
  ...
  set(dpdk_source_dir ${THIRD_PARTY_DIR}/spdk/dpdk)
  ...
  ExternalProject_Add(dpdk-ext
    ...
    CONFIGURE_COMMAND ${meson_exe} setup ${dpdk_dir} ${dpdk_dir}/build --prefix=${dpdk_dir}/build --reconfigure
    BUILD_COMMAND ninja -C ${dpdk_dir}/build
    BUILD_IN_SOURCE 1
    INSTALL_COMMAND ninja install -C ${dpdk_dir}/build
    LOG_CONFIGURE ON
    LOG_BUILD ON
